...
def extract_add_knowledge_column_params(llm_output: str) -> Tuple[List[str], List[List[Any]]]:
    """
    LLMf_add_knowledge_column
    ...
    pattern = r"f_add_knowledge_column\((.*?)\)"
...
def process_add_knowledge_column(table_data: List[List[Any]], new_columns: List[str], new_values: List[Any] = None) -> List[List[Any]]:
    """
    ...
    print("add_knowledge_column--add_knowledge_column--add_knowledge_column--add_knowledge_column--add_knowledge_column--add_knowledge_column--add_knowledge_column")
    ...
    for i in range(1, len(table_data)):
        if new_values[i-1] in table_data[i]:
            return []
