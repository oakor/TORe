...
def extract_add_inferred_column_params(llm_output: str) -> Tuple[List[str], List[List[Any]]]:
    """
    LLMf_add_inferred_column
    ...
    pattern = r"f_add_inferred_column\((.*?)\)"
...
def process_add_inferred_column(table_data: List[List[Any]], new_columns: List[str], new_values: List[Any] = None) -> List[List[Any]]:
    """
    ...
    print("add_inferred_column--add_inferred_column--add_inferred_column--add_inferred_column--add_inferred_column--add_inferred_column--add_inferred_column")
