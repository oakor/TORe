...
"""
from examples.task_0 import task_0_EXAMPLES
from examples.task_1 import task_1_EXAMPLES
from examples.task_2 import task_2_EXAMPLES
from examples.task_3 import task_3_EXAMPLES
from examples.task_4 import task_4_EXAMPLES
from examples.task_5 import task_5_EXAMPLES
from examples.task_6 import task_6_EXAMPLES
from examples.task_7 import task_7_EXAMPLES
from examples.task_8 import task_8_EXAMPLES
import random

EXAMPLES = [task_0_EXAMPLES, task_1_EXAMPLES, task_2_EXAMPLES, task_3_EXAMPLES, task_4_EXAMPLES, task_5_EXAMPLES, task_6_EXAMPLES, task_7_EXAMPLES, task_8_EXAMPLES]
...
def generate_chain_param_prompt(table_info: str, chain: list, task_id: int, random_seed: int) -> str:
    """Generate prompt for chain parameter generation"""
    random.seed(random_seed)
    task_example = EXAMPLES[task_id]
...
def generate_qa_prompt(original_table: str, chain_with_params: list, 
                      final_table: str, task_id: int, random_seed: int) -> str:
